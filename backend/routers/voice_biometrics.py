...
if not IS_PRODUCTION:
    try:
        ...
        print("[INFO] Voice Biometrics: REAL PyTorch model loaded (localhost mode)")
    except Exception as e:
        print(f"[WARN] Voice Biometrics: PyTorch load failed ({e}), falling back to demo mode")
else:
    print("[INFO] Voice Biometrics: Running in DEMO mode (Render production -- 512MB RAM limit)")
